...
基于 React + TypeScript + Ant Design + SortableJS 的前端组件功能展示平台，包含 51+ 组件演示和 AI 提示词模板。

## 技术栈

React、TypeScript、Ant Design、SortableJS

## 组件分类

### 拖拽排序
基于 SortableJS 实现的各种拖拽场景，包括列表拖拽、网格拖拽、跨容器拖拽等。

### 数据展示
表格、树形控件、列表、卡片等多种数据展示组件。

### 表单组件
各种表单控件，包含验证、联动、动态表单等场景。

### 反馈组件
弹窗、抽屉、通知、气泡确认等交互反馈组件。

### AI 模板
结合 AI 生成组件代码的提示词模板库，提高开发效率。

## 架构

采用按需加载 + 示例代码展示的模式，每个组件独立可运行，并附带完整的代码示例。
